...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ftpf_hexafloat_conv.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lcharbon <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/06/07 01:34:15 by lcharbon          #+#    #+#             */
/*   Updated: 2017/07/24 00:53:13 by lcharbon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ftpf_hexafloat_conv(t_data *data, va_list ap)
{
	...
	str = ftpf_float_itoa(arg, data->data[0], 1, over_pre);
	if (data->data[0] > 0 && arg == 0)
		str = ft_strjoindel(str,
		ft_strnewch(data->data[0] - (int)ft_strlen(str) + 2, '0'), 3);
