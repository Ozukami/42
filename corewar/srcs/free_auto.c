...
/*   Updated: 2017/07/29 05:39:17 by qumaujea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	free((((((automaton->next)[6]->next)[0]->next)[0]->next)[0])->next);
	...
	free(((((automaton->next)[5]->next)[0]->next)[0])->next);
	...
	free(((((automaton->next)[4]->next)[1]->next)[0]->next));
	free((((automaton->next)[4]->next)[1]->next)[0]);
	free((((automaton->next)[4]->next)[1]->next));
	free(((((automaton->next)[4]->next)[0]->next)[0])->next);
	...
	free((((automaton->next)[3]->next)[0])->next);
	free(((automaton->next)[3]->next)[0]);
	free(((automaton->next)[3]->next));
	free((automaton->next)[3]);
	free(((((((automaton->next)[2]->next)[1]->next)[0]->next)[0]->next)[0])->next);
...
void		free_automaton(t_state *automaton)
{
	...
	free(((((automaton->next)[2]->next)[0]->next)[0])->next);
	...
	free((((((automaton->next)[1]->next)[0]->next)[0]->next)[0])->next);
	...
	free(((((automaton->next)[0]->next)[2]->next)[0])->next);
	free((((automaton->next)[0]->next)[2]->next)[0]);
	free(((((automaton->next)[0]->next)[1]->next)[0])->next);
	free((((automaton->next)[0]->next)[1]->next)[0]);
	free(((((automaton->next)[0]->next)[0]->next)[0])->next);
